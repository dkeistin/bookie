        ...
        <ContentBox.Body>
          <div className="referrals-screen__control">
            ...
            <div className="referrals-screen__control-text">
              ...
              <Typography component="p" className="text-dark-3">
          ...
          <Typography component="h5">Earn Tier 2 (5%) at <Typography component="span" className="text-regular text-dark-3">- 10 Referrals + $500 wagered</Typography>
          </Typography>
        </ContentBox.Body>
      </ContentBox>
    </ScreenLayout>
