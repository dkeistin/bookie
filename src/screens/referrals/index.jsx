        ...
        <ContentBox.Body>
          ...
          <div className="referrals-screen__control">
            ...
            <div className="referrals-screen__control-text">
              <Typography component="h6">Share the link above or have friends use the promo code <Typography component="span" className="text-secondary">“fortbettor”</Typography>.<br />
              </Typography>
              <Typography component="p" className="text-quaternary-dark">
          ...
          <Typography component="h6">Earn Tier 2 (5%) at <Typography component="span" className="text-regular text-quaternary-dark">- 10 Referrals + $500 wagered</Typography>
          </Typography>
        </ContentBox.Body>
      </ContentBox>
    </ScreenLayout>
