  ...
  return [
    {
      header: () => (
        <RowGroup>
          ...
          <Typography component="span" className="text-quaternary-dark">0.5% of weekly amount wagered</Typography>
        </RowGroup>
      ),
      body: () => (
        <div className="rewards-screen__content">
          <Typography component="h4" className="rewards-screen__content-title">Level 1</Typography>
          <Typography component="p" className="rewards-screen__content-text text-quaternary-dark">Level up to increase lossback and rakeback from the month prior</Typography>
          ...
          <Typography component="p" className="rewards-screen__content-info text-bold">
            Wager <Typography component="span" className="text-secondary">$25.00</Typography> for next level
          </Typography>
    ...
    },
    {
      header: () => (
        <RowGroup>
          ...
          <Typography component="span" className="text-quaternary-dark">1.00% of monthly losses + 0.5% of monthly amount wagered</Typography>
        </RowGroup>
      ),
      body: () => (
        <div className="rewards-screen__content">
