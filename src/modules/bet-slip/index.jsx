  ...
  return (
    <div className="bet-slip">
      <div className="bet-slip__header">
        <Typography component="span" variant="p-sm" className="text-quaternary-dark bet-slip__header-title">{title}</Typography>
      ...
      <div className="bet-slip__details">
        ...
        <Typography component="span" variant="h6" className="text-tertiary bet-slip__details-price">{price}</Typography>
      </div>
